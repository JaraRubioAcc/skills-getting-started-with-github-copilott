...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for competitive play and skill-building",
        "schedule": "Tuesdays, Thursdays, Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "lisa@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice basketball drills, teamwork, and friendly matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, practice acting, and put on performances",
    ...
    "Debate Team": {
        ...
        "max_participants": 18,
        "participants": ["camila@mergington.edu", "ethan@mergington.edu"]
    }
}
